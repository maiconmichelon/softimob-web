...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { dataAdmissao: @funcionario.dataAdmissao, departamento_id: @funcionario.departamento_id }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { dataAdmissao: @funcionario.dataAdmissao, departamento_id: @funcionario.departamento_id }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
